            ...
            <div class="container">
                ...
                <div class="card">
                    <div class="card-header">
                            ...
                            <a href="<?= base_url(); ?>stok/keluar" style="text-decoration:none"><i class="fas fa-arrow-left">
                            </i> </a>
                            </span>
                        &nbsp;
					...
					<form method="POST" action="<?= base_url(); ?>stok/keluarBarang/1">
                        ...
                        <input type="hidden" name="user" value="<?= $this->session->userdata("nama"); ?>">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <input type="text" <?php if (isset($k) == !null){
                                                ...
                                                echo 'readonly';
                                            } ?> class="form-control" id="kode" name="kode" value="<?php if (isset($kode)) {
                                                echo $kode;
                                            }else{
                                                echo $brg['id_barang']; 
                                            }?>">
                                        </div>
                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tampilBrg"><i class="fas fa-search-plus"></i></button>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <select class="form-control custom-select" name="ket">
                                        ...
                                        <option <?php if ($ket1 == 'Kadaluarsa') {
                                            echo 'selected';
                                        } ?> value="Kadaluarsa">Kadaluarsa</option>
                                        <option <?php if ($ket1 == 'Rusak') {
                                            echo 'selected';
                                        } ?> value="Rusak">Rusak</option>
                                        <option <?php if ($ket1 == 'lainnya') {
                                            echo 'selected';
                            ...
                            <button type="submit" class="btn btn-primary float-right">Tambah</button>
                                ...
                                <span style="font-size: 25px; color: Dodgerblue;">
                                    <a href="<?= base_url(); ?>stok/tambahKeluar" style="text-decoration:none"><i class="fas fa-redo-alt"></i> </a>
                                </span>
                        </form>
                    </div>
                </div>
...
<!-- Modal lihat Brg -->
<div class="modal fade" id="tampilBrg" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <tbody>
                        ...
                        foreach ($barang as $brg) : ?>
                            <tr>
                                ...
                                <td><?= $brg['stok']; ?></td>
                                <td>
                                    <a href="<?= base_url(); ?>stok/keluarBarang/<?= $brg['id_barang']; ?>" class="btn"><span style="font-size: 20px; color: green;"> <i class="fas fa-arrow-circle-down"> pilih</i> </span></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
