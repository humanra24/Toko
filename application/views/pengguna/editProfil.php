            ...
            <div class="container">
                ...
                <div class="card">
                    <div class="card-header">
                            ...
                            <a href="<?= base_url(); ?>dashboard" style="text-decoration:none"><i class="fas fa-arrow-left">
                            </i> </a>
                            </span>
                        &nbsp;
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" readonly class="form-control" id="golongan" name="golongan" value="Admin" />
                            </div>
                            <div class="col-sm-4"></div>
                                <div class="col-sm-8">
                                ...
                                <span style="font-size: 25px; color: Dodgerblue;">
                                <a href="<?= base_url(); ?>pengguna/editProfil/1" style="text-decoration:none"><i class="fas fa-redo-alt"></i> </a>
                                </span>
