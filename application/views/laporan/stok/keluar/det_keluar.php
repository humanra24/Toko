<div class="card">
	<div class="card-header">
		<span style="font-size: 25px; color: Dodgerblue;">
			<a href="<?= base_url(); ?>laporan/stokKeluar" style="text-decoration:none"><i class="fas fa-arrow-left">
				</i> </a>
		</span>
		&nbsp;
		<span style="font-size: 25px;">
			Detail Laporan Stok Keluar
		</span>
		<span class="float-right">
			<form action="<?= base_url(); ?>laporan/cetakKeluar" target="_blank" method="post">
