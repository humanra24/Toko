<form action="<?= base_url() ?>laporan/cetakAllKeluar" target="_blank" method="post">
...
<form action="<?= base_url() ?>laporan/cekTglKeluar" method="post">
    <div class="form-inline">
        ...
        <span style="font-size: 25px; color: Dodgerblue;">
            <a href="<?= base_url(); ?>laporan/stokKeluar" title="reset" style="text-decoration:none"><i class="fas fa-redo-alt"></i> </a>
        </span>
    </div>
</form>
        ...
        <tbody>
            ...
            foreach ($laporan as $lapor) : ?>
                <tr>
                    ...
                    <td>
                    <form action="<?= base_url(); ?>laporan/det_keluar" method="post">
                        <input type="hidden" name="tgl" value="<?= $lapor['tgl']; ?>">
                        <button type="submit" class="btn btn-info" title="Detail" id="btnDetail"><i class="fas fa-info"></i></button>
                    </form>
                    </td>
                </tr>
            <?php endforeach ?>
